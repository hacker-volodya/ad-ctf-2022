...
public class Crypto {
    ...
    public static class WrongNonceSizeException extends Exception {
        @Serial
        private static final long serialVersionUID = 2687731889587117531L;
    }

    public static class WrongKeySizeException extends Exception {
        @Serial
        private static final long serialVersionUID = -290509589749955895L;
    }

    public Crypto(byte[] key, byte[] nonce, int counter)
